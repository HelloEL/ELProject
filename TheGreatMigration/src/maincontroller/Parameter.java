...
public class Parameter {
	...
	private static int population = 125000000;
	private static int averageHealth = 95;
	private static int degreeOfChaos = 0;//when it comes to 100,game over
	private static int averageSatisfaction = 80;
	private static int day = 0;//count time
	private static int timeInDay = 80;//0 <= timeInDay <= SECOND_PER_DAY
	private static int migrationSpeed = 80;
	...
	public static void update(int sfChange, int lszzChange, int lsxxChange,
			int jkChange, int slChange, int myChange) {
		// TODO 自动生成的方法存根
